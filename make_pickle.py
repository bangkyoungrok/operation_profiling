...
tensor = np.random.uniform(-1, -0.3, (100, 256, 256))
print(tensor)
with open(f'/workspace/tensors/input_tensor/input_tensor_-1~-0.3.pickle', 'wb') as fw:
    pickle.dump(tensor, fw)
    
tensor = np.random.uniform(-0.3, 0.3, (100, 256, 256))
with open(f'/workspace/tensors/input_tensor/input_tensor_-0.3~0.3.pickle', 'wb') as fw:
    pickle.dump(tensor, fw)
    
tensor = np.random.uniform(0.3, 1, (100, 256, 256))
with open(f'/workspace/tensors/input_tensor/input_tensor_0.3~1.pickle', 'wb') as fw:
    pickle.dump(tensor, fw)
