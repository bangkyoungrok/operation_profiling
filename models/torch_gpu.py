...
torch_exp_output = torch.exp(torch_input)
torch_exp_output = torch_exp_output.to('cpu')
print(f"torch_softmax_output : {torch_exp_output}") 

with open("../tensors/gpu_output/gpu_torch_exp_output.pickle", "wb") as fw:
    pickle.dump(torch_exp_output, fw)
...
with open("../tensors/gpu_output/gpu_torch_softmax_output.pickle", "wb") as fw:
...
with open("../tensors/gpu_output/gpu_torch_GeLU_output.pickle", "wb") as fw:
...
with open("../tensors/gpu_output/gpu_torch_tanh_output.pickle", "wb") as fw:
...
with open("../tensors/gpu_output/gpu_torch_sigmoid_output.pickle", "wb") as fw:
...
with open("../tensors/gpu_output/gpu_torch_swish_output.pickle", "wb") as fw:
